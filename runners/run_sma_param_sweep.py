...
import itertools
import logging
from core.pipeline import build_asset_regime_dataset
from core.signal_generator import add_risk_onoff_signal
from core.backtest import simple_long_only_backtest
...
def run_sweep():
    ...
    from utils.data_fetcher import get_binance_ohlc
    ...
    for i, (sma_s, sma_l) in enumerate(valid_params):
        ...
        from core.indicators import add_sma, add_rsi, add_atr
        from core.regimes import add_basic_regimes, add_risk_state
